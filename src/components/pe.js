        ...
        <div className="auth-inner2">
            <form>
                ...
                <div className="form-group">
                    ...
                    <input type="number" className="form-control" placeholder="Product ID" required/>
                </div>

                <div className="form-group">
                    <label>Store ID</label>
                    <input type="number" className="form-control" placeholder="Store ID" required />
                </div>

                <div className="form-group">
                    <label>Product Quantity</label>
                    <input type="number" className="form-control" placeholder="Product Quantity" required/>
                </div>

                <div className="form-group">
                    <label>Manufacture Date</label>
                    <input type="date" className="form-control" placeholder="Manufacture Date" required/>
                </div>
